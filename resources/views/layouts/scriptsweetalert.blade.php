...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        window.livewire.on('swalMessage', (tipe, text) => {
            Swal.fire({
                toast: true,
                position: 'top',
                showConfirmButton: false,
        ...
        window.livewire.on('swalAndaYakinTrigger', (tujuan, pesan) => {
            Swal.fire({
                title: 'Anda yakin?',
                text: pesan,
                icon: 'warning',
        ...
        window.livewire.on('swalAndaYakinTriggerWithEnding', (tujuan, pesan) => {
            Swal.fire({
                title: 'Anda yakin?',
                text: pesan,
                icon: 'warning',
        ...
        window.livewire.on('swalCheckboxPilihRole', (html, idAnggota) => {
            ...
            const {
                ...
                if (result.value) {
                    ...
                    var hasilsatu;
                    Array.prototype.forEach.call(document.getElementsByName('satu'), function (
                        el) {
                    ...
                    Array.prototype.forEach.call(document.getElementsByClassName(
                        'divCheckboxRole'), function (el) {
                        if (el.childNodes['0'].checked) hasildua.push(el.childNodes['0']
                            .value)
                    })

                    window.livewire.emit('terkonfirmasiEditRole', hasilsatu, hasildua,
                        idAnggota)
                    ...
                    if (result.isConfirmed) {
                        ...
                        Swal.fire({
                            ...
                            if (hasil.value) {
                                ...
                                window.livewire.emit('terkonfirmasiKepengurusanBaru', result
                                    .value)
