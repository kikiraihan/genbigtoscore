...
<div>
    ...
    <div id="atas" class="container mx-auto bg-gray-100 mb-28 px-3 md:px-0">
        ...
        <div class="flex justify-between items-center mt-6">
            ...
            <div>
                <div class="f-roboto">
                    <span class="text-xs text-gray-400">Uang Kas Terakhir :</span>
                    <span class="text-sm">
                        @if ($anggota->TanggalBayarUangKas)
                        <x-kiki.badge class="bg-green-200 text-gray-500">
                            Beasiswa {{$anggota->BeasiswaDiterimaTerakhir->tahun}}/{{$anggota->BeasiswaDiterimaTerakhir->semester}}, Dibayar {{$anggota->TanggalBayarUangKas->format('d F Y')}}
                        </x-kiki.badge>
                        @else
                        <x-kiki.badge class="bg-red-200 text-gray-500">
                            Beasiswa {{$anggota->BeasiswaDiterimaTerakhir->tahun}}/{{$anggota->BeasiswaDiterimaTerakhir->semester}}, Belum Bayar
                        </x-kiki.badge>
                        @endif
                    </span>
                </div>
        ...
        <div class="bg-white shadow-md rounded overflow-x-auto">
            <table class="min-w-max w-full table-auto">
                ...
                @if ($item->pivot->kondisi==" tidakhadir") bg-red-50 @elseif ($item->pivot->kondisi=="izin")
                        bg-yellow-100
                        @endif
                        ">
                        ...
                        <td class="py-3 px-6 text-center">
                            <span class="text-center capitalize font-semibold space-x-2">
                                ...
                                <div class="inline-flex items-center space-x-1 bg-gray-200 text-gray-600 rounded">
                                    <span
                                        class="material-icons-outlined text-sm rounded-l p-0.5 text-white @if ($item->absensiable->id==1) bg-blue-500 @elseif ($item->absensiable->id==2) bg-red-400 @elseif ($item->absensiable->id==3) bg-green-400 @elseif ($item->absensiable->id==4) bg-yellow-400 @endif">
                                        people
                                    </span>
                ...
                <tbody class="text-gray-600 text-sm font-light">
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-left whitespace-nowrap capitalize select-none">
                            ...
                            <span
                                class="bg-blue-100 text-blue-500 border border-blue-200 py-0.5 px-1.5 rounded text-xs">
                                Anggota
                            </span>
